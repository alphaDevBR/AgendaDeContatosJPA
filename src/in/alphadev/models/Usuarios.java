 ...
 */
@Entity
@Table(name = "usuarios", catalog = "db_fatec", schema = "")
@XmlRootElement
@NamedQueries({
  ...
  @NamedQuery(name = "Usuarios.findByUsuarioAndSenha", query = "SELECT u FROM Usuarios u WHERE u.usuario = :usuario AND u.senha = :senha")
})
